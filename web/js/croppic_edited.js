...
(function (window, document) {
	...
	Croppic.prototype = {
		...
		zoom :function(x){
            ...
            if( newWidth * allowSmallerFactor < that.objW || newHeight * allowSmallerFactor < that.objH){

                if( newWidth - that.objW < newHeight - that.objH ){
                    newWidth = that.objW/allowSmallerFactor;
                    newHeight = newWidth/ratio;
                }else{
                    newHeight = that.objH/allowSmallerFactor;
            ...
            if(!that.options.scaleToFill && (newWidth*allowSmallerFactor > that.imgInitW || newHeight*allowSmallerFactor > that.imgInitH)){

                if( newWidth - that.imgInitW < newHeight - that.imgInitH ){
                    newWidth = that.imgInitW/allowSmallerFactor;
                    newHeight = newWidth/ratio;
                }else{
                    newHeight = that.imgInitH/allowSmallerFactor;
                    newWidth = ratio * newHeight;
                }
